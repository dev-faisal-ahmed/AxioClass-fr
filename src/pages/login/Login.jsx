...
const Login = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row justify-center items-center h-screen w-screen">
      ...
      <div className="flex flex-col gap-4 justify-center items-center md:items-start h-full md:w-1/3 md:border p-6 md:p-12 shadow-lg hover:shadow-xl transition-all">
